...
# Batch wrapper for classify_repos.sh
# Usage: bash classify_batch.sh <INPUT_JSON_FILE>
...
# Loop through each URL and invoke classify_repos.sh
for repo_url in "${REPO_URLS[@]}"; do
  echo "\n===== Processing $repo_url ====="
  bash classify_repos.sh "$repo_url"
done 